...
ActiveRecord::Schema.define(version: 2022_05_19_060445) do
  ...
  create_table "gambles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["events_id"], name: "index_gambles_on_events_id", unique: true
  end
  ...
  add_foreign_key "gambles", "events", column: "events_id"
